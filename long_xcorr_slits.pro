...
;;ORIGINAL: if (NOT keyword_set(maxlag)) then maxlag = 15L
if (NOT keyword_set(maxlag)) then maxlag = 30L
lags = lindgen(2L * maxlag + 1L) - floor(maxlag/2)

;sky, image1*(image2 GT 0), skymode, skysig, /silent
sky, image1[where(image2 GT 0)], skymode, skysig, /silent
