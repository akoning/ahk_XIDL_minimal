...
;   Changed by AHK to call long_reduce_work_less.pro instead of
;   long_reduce_work.pro
;
; CALLING SEQUENCE:
...
;-  
;-----------------------------------------------------------------------------
PRO long_reduce_less, planfile, clobber = clobber, verbose = verbose $
                 ...
                 , _EXTRA = extra, wavemaskType = wavemaskType
...
;          iflat = where(qtwi OR qdome)
         ...
         ;; Can work on getting as many masks as possible to
         ;; here. (Working in Gold directories)
         ...
         for isci = 0L, nsci-1 do begin
             ...
             if (ct EQ 0 OR keyword_set(sci_clobber)) THEN BEGIN
                 ...
                 ;stop
                 long_reduce_work_less, djs_filepath(planstr[j].filename $
